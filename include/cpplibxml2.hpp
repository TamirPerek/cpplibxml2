...
namespace cpplibxml2 {
    enum class ParserOptions : int {
        ...
        /* since 2.13.0 */
        NoXXE    = 1<<23,/* disable loading of external content */
        /* since 2.14.0 */
    ...
    public:
        ...
        [[nodiscard]] static std::expected<Doc, Error> parseFile(const std::filesystem::path &, ParserOptions options = ParserOptions::NoEnt | ParserOptions::DtdLoad) noexcept;

        [[nodiscard]] static std::expected<Doc, Error> parse(std::string_view, ParserOptions = ParserOptions::NoEnt | ParserOptions::DtdLoad) noexcept;
